...
import net.mcreator.bedrockmod.potion.RainbowFlightMobEffect;

import java.util.List;
import java.util.ArrayList;

@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
public class BedrockmodModMobEffects {
	private static final List<MobEffect> REGISTRY = new ArrayList<>();
	public static final MobEffect RAINBOW_FLIGHT = register(new RainbowFlightMobEffect());
