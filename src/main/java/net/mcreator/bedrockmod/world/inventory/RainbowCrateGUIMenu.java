...
public class RainbowCrateGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public RainbowCrateGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(BedrockmodModMenus.RAINBOW_CRATE_GUI, id);
