...
public class EvilBlockBlock extends BedrockmodModElements.ModElement {
	@ObjectHolder("bedrockmod:evil_block")
	public static final Block block = null;

	public EvilBlockBlock(BedrockmodModElements instance) {
		super(instance, 76);
	}
