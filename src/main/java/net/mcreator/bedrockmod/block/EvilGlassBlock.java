...
public class EvilGlassBlock extends BedrockmodModElements.ModElement {
	@ObjectHolder("bedrockmod:evil_glass")
	public static final Block block = null;

	public EvilGlassBlock(BedrockmodModElements instance) {
		super(instance, 84);
	}
