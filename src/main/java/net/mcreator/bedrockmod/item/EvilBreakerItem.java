...
public class EvilBreakerItem extends BedrockmodModElements.ModElement {
	@ObjectHolder("bedrockmod:evil_breaker")
	public static final Item block = null;

	public EvilBreakerItem(BedrockmodModElements instance) {
		super(instance, 87);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("evil_breaker"));
	}

	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(EviltabItemGroup.tab).maxDamage(0));
		}
