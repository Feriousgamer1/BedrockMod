...
public class SupeItem extends BedrockmodModElements.ModElement {
	@ObjectHolder("bedrockmod:supe")
	public static final Item block = null;

	public SupeItem(BedrockmodModElements instance) {
		super(instance, 33);
	}
	...
	public static class FoodItemCustom extends Item {
		public FoodItemCustom() {
			super(new Item.Properties().group(ItemGroup.FOOD).maxStackSize(64).rarity(Rarity.EPIC)
					.food((new Food.Builder()).hunger(2).saturation(2f).setAlwaysEdible().meat().build()));
