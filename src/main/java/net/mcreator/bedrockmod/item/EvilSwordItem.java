...
public class EvilSwordItem extends BedrockmodModElements.ModElement {
	@ObjectHolder("bedrockmod:evil_sword")
	public static final Item block = null;

	public EvilSwordItem(BedrockmodModElements instance) {
		super(instance, 65);
	}
	...
	public void initElements() {
		...
		}, 3, 16f, new Item.Properties().group(EviltabItemGroup.tab)) {
		}.setRegistryName("evil_sword"));
	}
}
