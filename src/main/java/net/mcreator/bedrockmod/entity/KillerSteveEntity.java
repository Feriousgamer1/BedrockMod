...
import net.mcreator.bedrockmod.entity.renderer.KillerSteveRenderer;
import net.mcreator.bedrockmod.BedrockmodModElements;

@BedrockmodModElements.ModElement.Tag
public class KillerSteveEntity extends BedrockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.6f, 1.8f)).build("killer_steve").setRegistryName("killer_steve");

	public KillerSteveEntity(BedrockmodModElements instance) {
		super(instance, 34);
		FMLJavaModLoadingContext.get().getModEventBus().register(new KillerSteveRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -16777012, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("killer_steve_spawn_egg"));
	}
